...
export default function Dashboard({ assignments, pits, quizzes, setActivePage }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-900 px-8 pt-12 pb-20">
        <div className="max-w-6xl mx-auto">
          <p className="text-slate-300 text-sm mb-2">Dashboard Overview</p>
          <h1 className="text-white text-4xl font-bold mb-2">Dabee's Tracker</h1>
          <p className="text-slate-400 text-lg">{format(today, 'EEEE, MMMM do, yyyy')}</p>
        </div>
      </div>
